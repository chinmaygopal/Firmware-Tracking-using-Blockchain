...
const getCaUrl = async (org, ccp) => {
    let caURL;
    if (org == "Org1") {
        caURL = ccp.certificateAuthorities['ca.org1.firmwareupdate.com'].url;

    } else if (org == "Org2") {
        caURL = ccp.certificateAuthorities['ca.org2.firmwareupdate.com'].url;
    } else
        return null
    return caURL
...
const getCaInfo = async (org, ccp) => {
    let caInfo
    if (org == "Org1") {
        caInfo = ccp.certificateAuthorities['ca.org1.firmwareupdate.com'];

    } else if (org == "Org2") {
        caInfo = ccp.certificateAuthorities['ca.org2.firmwareupdate.com'];
    } else
        return null
    return caInfo
