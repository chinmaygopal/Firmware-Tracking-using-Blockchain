...
try{
    ...
    var chaincodeName = "firmware_update_contract";
    var fcn = "changeUpdateProgress";
    var args = ["d42cb4edbfe6cc4e3bb3c31403dc315c8e002c80bc438242da6cdf28c9ec6b1f","Rpi1","Stopped"];
    var username ="admin";
    var orgname = "Org1";
    let message = invoke.invokeTransaction(channelName, chaincodeName, fcn, args, username, orgname);
